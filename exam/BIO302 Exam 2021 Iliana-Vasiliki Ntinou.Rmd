...
pb <- ggplot(bc.df, aes( x=meansummertemp, y=biomass, colour=site, fill=site))+
      ...
      scale_colour_manual(values= c("#7570B3","#E7298A","#E6AB02", "#A6761D"), breaks = c("H", "A", "M", "L")) +
      
      scale_fill_manual(values=alpha(c("#7570B3","#E7298A","#E6AB02", "#A6761D"), .3), breaks = c("H", "A", "M", "L"))+
      
      ggtitle("Relationship between biomass and mean summer temperature per site")+
      
      labs(x="Mean Summer Temperature (C°)", y="Biomass (kg)", col="Site", fill="Site")+
